package cn.sdfirefly.crud.test;
...
import cn.sdfirefly.crud.bean.Employee;
import cn.sdfirefly.crud.dao.DepartmentMapper;
import cn.sdfirefly.crud.dao.EmployeeMapper;
 ...
 * @version
 * @date 2022年5月11日下午10:05:57
 * 
 *       推荐Spring的项目可以使用Spring的单元测试，可以自动注入我们需要的组件 1、导入SpringTest模块
